...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_predictions.txt")
head(x.data)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_fit.png", 
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_uncertainty.png", 
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_fit_TSS.png", 
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_fit_Kappa.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_5.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_5ppb.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_15.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_15ppb.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_50.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_50ppb.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_100.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_100ppb.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_50pc.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_50pc.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_200pc.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_200pc.png", 
...
x.data = read.delim("Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_ref.txt")
head(x.data)
x.data.sf = x.data %>% st_as_sf(coords = c("X_3035", "Y_3035")) %>% st_set_crs(3035)
...
ggsave(filename = "Data analyses/ISOE_LAC/mgcv_gam/ISOE_LAC_GAM_TP_ref.png", 
